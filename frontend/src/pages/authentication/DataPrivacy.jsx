...
function DataPrivacy() {
  ...
  return (
    <>
      <Header />
      <div className="text-black mx-4 md:mx-8 lg:mx-16 mt-8 h-screen flex flex-col">
        <h1 className="text-2xl mb-4 mt-4 font-bold">Data Privacy Agreement</h1>

        {/* Scrollable container */}
        <div
          className="flex-grow bg-[#D9D9D9] p-6 leading-loose overflow-y-auto"
        ...
        >
          ...
          <ul className="pl-5">
            ...
            <p>
              ...
              other interactions on the platform is strictly prohibited.
            </p>
          ...
          <p>
            We will retain your personal information as long as your account is
            active or as needed to provide you services. When your information
            is no longer required, we will delete it securely.
          </p>
          ...
          <p>
            ...
            of any changes by posting the new Data Policy on our platform.
          </p>
        </div>
        ...
        <div className="mt-4">
          ...
          <div className="flex items-center mb-2">
            ...
            <label htmlFor="check2" className="text-base font-normal">
              I agree to the use of my personal information for educational
              purposes of the University.
            </label>
          </div>
        </div>

        <div className="flex justify-center mt-8 mb-10 space-x-3">
          <button
