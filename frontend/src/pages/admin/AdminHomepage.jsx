                ...
                <ul className="carousel-news">
                  <li className="item">
                    ...
                    <div className="news-content">
                      ...
                      Offers key tools and insights for managing the system efficiently.
                      </p>
                      <button
                        style={{
                          marginTop:'10px',
                        ...
                        onMouseOver={(e) => (e.target.style.backgroundColor = '#232323')}
                        onMouseOut={(e) => (e.target.style.backgroundColor = '#be142e')}
                      >
                        Go to Dashboard
                      </button>
                    </div>
...
<div className="carousel-page">
  ...
  Manage Companies
                  ...
                  <div className="square-item">
                    ...
                    <div className="dropdown">
                      ...
                      <div className="dropdown-content">
                        ...
                        <button onClick={() => handleNavigation("/admin/events")}>
                          Events
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="square-item">
                    ...
                    <button onClick={() => handleNavigation("/admin/certifications")}>
                  ...
                  <div className="square-item">
                    ...
                    <h3>Documents</h3>
                    <button onClick={() => handleNavigation("/admin/documentrequest")}>
                      Manage Documents
                    </button>
                  </div>
                  <div className="square-item">
              ...
              <div className="carousel-page">
                <div className="square-container">
                  ...
                  <div className="square-item">
                    ...
                    <h3>Survey</h3>
                    <button onClick={() => handleNavigation("/admin/surveytool")}>
                      Manage Survey
                    </button>
                  </div>
                  <div className="square-item">
